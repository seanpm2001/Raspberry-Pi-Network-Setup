...
( [View yesterdays entry](/Learn-Pi/New-Pi/2022/January/18/) | [View tomorrows entry](/Learn-Pi/New-Pi/2022/January/20/) ) **Day 1:** `2022, Friday, January 7th` [Go back](/Learn-Pi/New-PI/2022/January/07/) )
...
**My setup:** [Canakit Raspberry Pi 4 extreme edition 8 GB RAM [Canakit.com] [⚠️ Link contains trackers]](https://www.canakit.com/raspberry-pi-4-extreme-aluminum-case-kit.html) with 2 1080p TV screens (used as monitors) [mouse, and wall mount links coming soon]
...
**Wall mount [2x]** - LINK COMING SOON

- Note: requires installation with a drill
...
**File version:** `1 (Thursday, 2022 January 20th at 6:17 pm)`

**Line count (including blank lines and compiler line):** `0,599`
