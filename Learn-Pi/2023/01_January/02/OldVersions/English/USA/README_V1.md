...
( [`View yesterdays entry (2023, Sunday, January 1st)`](/Learn-Pi/2023/01_January/01/) | **Today** `2023, Monday, January 2nd` | [`View tomorrows entry (2023, Tuesday, January 3rd)`](/Learn-Pi/2023/01_January/03/) )
...
**File version:** `1 (2023, Monday, January 2nd at 11:43 pm PST)`

**Line count (including blank lines and compiler line):** `984`

**Word count:** `5,574`

**Character count (including spaces):** `34,978`

**Character count (excluding spaces):** `29,386`

**Size (in bytes):** `34,978`
