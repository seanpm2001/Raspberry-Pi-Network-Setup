...
( [`View yesterdays entry (2023, Thursday, January 5th)`](/Learn-Pi/2023/01_January/05/) | **Today** `2023, Friday, January 6th` | [`View tomorrows entry (2023, Saturday, January 7th)`](/Learn-Pi/2023/01_January/07/) )
...
**File version:** `1 (2023, Sunday, January 8th at 11:14 pm PST)`

**Line count (including blank lines and compiler line):** `988`

**Word count:** `5,753`

**Character count (including spaces):** `35,934`

**Character count (excluding spaces):** `30,162`

**Size (in bytes):** `35,934`
