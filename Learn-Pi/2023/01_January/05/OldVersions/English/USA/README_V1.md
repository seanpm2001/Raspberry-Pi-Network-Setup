...
( [`View yesterdays entry (2023, Wednesday, January 4th)`](/Learn-Pi/2023/01_January/04/) | **Today** `2023, Thursday, January 5th` | [`View tomorrows entry (2023, Friday, January 6th)`](/Learn-Pi/2023/01_January/06/) )
...
**File version:** `1 (2023, Sunday, January 8th at 11:08 pm PST)`

**Line count (including blank lines and compiler line):** `984`

**Word count:** `5,608`

**Character count (including spaces):** `35,157`

**Character count (excluding spaces):** `29,530`

**Size (in bytes):** `35,157`
