...
( [`View yesterdays entry (2023, Friday, January 6th)`](/Learn-Pi/2023/01_January/06/) | **Today** `2023, Saturday, January 7th` | [`View tomorrows entry (2023, Sunday, January 8th)`](/Learn-Pi/2023/01_January/08/) )
...
**File version:** `1 (2023, Sunday, January 8th at 11:22 pm PST)`

**Line count (including blank lines and compiler line):** `1,000`

**Word count:** `6,043`

**Character count (including spaces):** `37,453`

**Character count (excluding spaces):** `31,393`

**Size (in bytes):** `37,453`
