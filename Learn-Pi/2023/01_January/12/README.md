...
( [`View yesterdays entry (2023, Wednesday, January 11th)`](/Learn-Pi/2023/01_January/11/) | **Today** `2023, Thursday, January 12th` | [`View tomorrows entry (2023, Friday, January 13th)`](/Learn-Pi/2023/01_January/13/) )
...
**File version:** `1 (2023, Friday, January 13th at 6:15 pm PST)`

**Line count (including blank lines and compiler line):** `1,378`

**Word count:** `8,065`

**Character count (including spaces):** `50,359`

**Character count (excluding spaces):** `42,240`

**Size (in bytes):** `50,623`
