...
( [`View yesterdays entry (2023, Tuesday, January 3rd)`](/Learn-Pi/2023/01_January/03/) | **Today** `2023, Wednesday, January 4th` | [`View tomorrows entry (2023, Thursday, January 5th)`](/Learn-Pi/2023/01_January/05/) )
...
**File version:** `1 (2023, Sunday, January 8th at 11:05 pm PST)`
...
**Character count (excluding spaces):** `29,444`

**Size (in bytes):** `35,049`
