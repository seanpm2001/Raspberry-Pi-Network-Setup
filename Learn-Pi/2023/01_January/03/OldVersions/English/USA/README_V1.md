...
( [`View yesterdays entry (2023, Monday, January 2nd)`](/Learn-Pi/2023/01_January/02/) | **Today** `2023, Tuesday, January 3rd` | [`View tomorrows entry (2023, Wednesday, January 4th)`](/Learn-Pi/2023/01_January/04/) )
...
**File version:** `1 (2023, Tuesday, January 3rd at 11:51 pm PST)`

**Line count (including blank lines and compiler line):** `984`

**Word count:** `5,574`

**Character count (including spaces):** `35,015`

**Character count (excluding spaces):** `29,416`

**Size (in bytes):** `35,015`
