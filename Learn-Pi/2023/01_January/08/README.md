...
( [`View yesterdays entry (2023, Saturday, January 7th)`](/Learn-Pi/2023/01_January/07/) | **Today** `2023, Sunday, January 8th` | [`View tomorrows entry (2023, Monday, January 9th)`](/Learn-Pi/2023/01_January/09/) )
...
**File version:** `1 (2023, Monday, January 9th at 1:25 pm PST)`

**Line count (including blank lines and compiler line):** `1,237`

**Word count:** `7,541`

**Character count (including spaces):** `46,613`

**Character count (excluding spaces):** `39,104`

**Size (in bytes):** `46,613`
